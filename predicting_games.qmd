...
subtitle: "{{< meta params.season >}} Season Game Predictions"
...
Notably, I **do not** use betting lines or the predictions of other models as features in my game prediction model. This allows me to directly compare my performance against that of other models.
...
How do these predictions compare to betting lines? The following plot shows my predicted spread against the opening spread from ESPN Bet.
...
How has the model performed against the spread?
