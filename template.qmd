...
To answer questions like these, Virgial Carter manually collected play-by-play data from the entire 1969 NFL season to try to calculate the expected value of field position.
...
How do we predict college football games?

. . .

We **measure** the efficiency of **every team's offense and defense** based on every play that has occurred over the course of a season.

We then use our estimated team ratings to simulate games.

::: aside

Technically, this measurement includes prior seasons with exponentially decaying weight. A full discussion of this is done would take some time; I would be happy to talk about in **exhausting detail** with you later.
...
My spread vs Vegas opening spread throughout the 2024 season. 
...
Beyond prediction, we can monitor team performance not by outcomes but on their underlying play - for which Wisconsin's recent performances have provided some positive news (mostly on defense).
...
My model still thinks Wisconsin's offense is rather mediocre, but it likes the recent performances on defense.
...
Models are about more than just prediction; they enable us to **make sense of patterns in data** and **measure outcomes we care about**.

. . .

The best work and the best predictions tend to come from **really trying to understand what you are are predicting**.
...
I don't think data science is [electricity]{.fg style="--col: #C6B90B"} and data the [new oil]{.fg style="--col: #C6B90B"}. I think it's something much simpler.
